...
echo ""
echo "Next steps:"
echo "  1. Open Claude Code in a Flutter or Next.js project"
...
echo ""
echo "Note: orchestration (compose/sequence/ship/status/promote/atlas-save/opus-execute/caveman)"
echo "      lives in the sibling product-workflow plugin. Install both for the full pipeline."
