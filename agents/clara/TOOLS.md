...
- `/theme-create` — palette nova
  - blank-page: 8 pré-condições obrigatórias
  - `--inspired-by <slug>` — biblioteca de 20 marcas
  - `--browse <category>` — wrapper para inspired-by
  - `--inspired-by-school <slug>` — 12 filosofias (Müller-Brockmann, Pentagram, etc.)
...
Ordem de pickiness (mais picky → menos):
1. Spacing scale adherence
2. Hierarchy weight
3. Color commitment + WCAG
4. Typographic rhythm
5. Microcopy as design
6. Density commitment
7. Motion earns presence
8. Symmetry vs hierarchy
9. Reuse before invention

(Adicione notas sobre flags e edge cases conforme acumula.)
