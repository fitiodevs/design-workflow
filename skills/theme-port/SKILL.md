...
- **Português:** `/Elo`, `/elo`, `/theme-port`, `/figma-port`, "porta esse frame", "implementa a tela X", "converte esse mockup pra Flutter", "migra do figma pro flutter"
...
- Se a saída lista counterexamples de Olavo ou Lupa, **inclui no preâmbulo do port**:
...
- ❌ Copiar texto em inglês do source — copy final é pt-BR (do handoff Olavo / `docs/product.md` §4); se o HTML veio de gerador EN-only, traduzir.
